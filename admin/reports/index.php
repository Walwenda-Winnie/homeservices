		...
		<div class="container-fluid">
			...
			<table class="table table-bordered table-striped">
				...
				<tbody>
					...
					$sql = "SELECT t.*,s.name as service,concat(lastname,', ', firstname,' ',middlename) as user from `transaction_list` t inner join service_list s on t.service_id = s.id inner join users u on t.user_id = u.id {$uwhere} order by unix_timestamp(t.`date_created`) desc ";
					$qry = $conn->query($sql);
