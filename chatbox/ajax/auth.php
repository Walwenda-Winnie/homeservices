...
if(isset($_GET['name'])){
    ...
    if($name=="" || $user1=="" || $user2=="" || $pass1=="" || $pass2==""){
        ...
        echo "<script>alert('Name should be less than 20 and greater than 4 characters..');</script>";
    }
    else if($user1 != $user2){
        ...
        echo "<script>alert('Password should be less than 20 and greater than 4 characters..');</script>";
    }
