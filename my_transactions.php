            ...
            <div class="container-fluid">
                <table class="table table-bordered table-stripped">
                    ...
                    <tbody>
                        <?php 
                        $i = 1;
                        $qry = $conn->query("SELECT t.*,s.name as service from `transaction_list` t inner join service_list s on t.service_id = s.id where t.user_id = '{$_settings->userdata('id')}' order by unix_timestamp(t.`date_created`) desc ");
